...
const SuccessPage = () => {
  ...
  return (
    <div className="py-10 md:py-20 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="w-24 h-24 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg"
        >
