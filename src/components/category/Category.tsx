...
function Category() {
  return (
    <div className="flex justify-center items-center">
      <div className="md:w-[1240px] md:h-[816px] bg-[#F0F0F0] rounded-[40px] mt-6 md:mt-16 pt-6 md:pt-0 pb-6 md:pb-0 flex flex-col justify-center items-center">
        <h1 className="font-bold text-5xl mb-6 md:mb-16 text-wrap md:text-nowrap text-center">
